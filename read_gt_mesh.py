...
# Example usage
'''
obj_file = '$HOME/autodl-tmp/dataset/dg-mesh/bird/mesh_gt/bluebird_animated0.obj'
mtl_file = '$HOME/autodl-tmp/dataset/dg-mesh/bird/mesh_gt/bluebird_animated0.mtl'
